...
ALTER TABLE IF EXISTS ONLY public.payroll_payments DROP CONSTRAINT IF EXISTS payroll_payments_employee_id_employees_id_fk;
ALTER TABLE IF EXISTS ONLY public.payroll_items DROP CONSTRAINT IF EXISTS payroll_items_payroll_payment_id_payroll_payments_id_fk;
ALTER TABLE IF EXISTS ONLY public.payroll_item_types DROP CONSTRAINT IF EXISTS payroll_item_types_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.employees DROP CONSTRAINT IF EXISTS employees_company_id_companies_id_fk;
ALTER TABLE IF EXISTS ONLY public.deductions DROP CONSTRAINT IF EXISTS deductions_payroll_payment_id_payroll_payments_id_fk;
...
ALTER TABLE IF EXISTS ONLY public.payroll_items DROP CONSTRAINT IF EXISTS payroll_items_pkey;
ALTER TABLE IF EXISTS ONLY public.payroll_item_types DROP CONSTRAINT IF EXISTS payroll_item_types_pkey;
...
DROP TABLE IF EXISTS public.payroll_item_types;
